...
<head>
	...
	<title><?php echo $fetcharry[1]; ?> | Doctor Panel</title>
</head>
<body>
			...
			<div class="col-md-12 col bg-light border-bottom py-3 fixed-top">
				<div class="row">
					<div class="col-md-4 col-sm-6 col-6">
						<img src="../admin/<?php echo $fetcharry[12]; ?>" class="img-fluid logo">
					</div>
					<div class="col-md-8 col-sm-6 col-6 text-right">
						<div class="dropdown" style="float:right;">
							<img src="../admin/<?php echo $fetcharry[13]; ?>" class="dropbtn">

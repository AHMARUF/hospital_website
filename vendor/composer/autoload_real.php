...
class ComposerAutoloaderInit136878d7458db1959617829108382025
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit136878d7458db1959617829108382025::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire136878d7458db1959617829108382025($fileIdentifier, $file);
        }
...
function composerRequire136878d7458db1959617829108382025($fileIdentifier, $file)
{

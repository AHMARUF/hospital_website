...
//eidt Get id 
  ...
  if(isset($_GET["editId"])) { 
  	$insert=$mysqli->query("select * from department where id='".$_GET["editId"]."'");
...
//update 
  ...
  if (isset($_POST['update'])) {
  	$update=$mysqli->query("UPDATE `department` SET `name` = '$department_name', `description` = '$description',`status` = '$status' WHERE `department`.`id` = '$id'");
  	if ($update) {
				...
				<div class="card">
					...
					<div class="card-body">
			          ...
			          <div class="form-group">
			            ...
			            <input type="text" name="department_name" class="form-control" id="recipient-name" value="<?php echo $fetcharry[1]; ?>">
			          </div>
			          <div class="form-group">
			            <label for="message-text" class="col-form-label">Description :</label>
			            <textarea name="description" class="form-control" id="message-text"><?php echo $fetcharry[2]; ?></textarea>
			          </div>
			          <div class="form-group">
			            <label for="message-text" class="col-form-label">Status :</label> &nbsp;
			            <input type="radio" name="status" value="1" <?php if($fetcharry[3]=='1'){ echo "checked=checked";}  ?>/>&nbsp;Active&nbsp;&nbsp;
			            <input type="radio" name="status" value="0" <?php if($fetcharry[3]=='0'){ echo "checked=checked";}  ?>/>&nbsp;Inactive
			          </div>
					</div>
